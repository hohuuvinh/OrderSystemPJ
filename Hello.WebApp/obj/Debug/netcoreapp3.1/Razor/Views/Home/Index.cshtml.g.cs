#pragma checksum "C:\Users\KimAnh\source\repos\OrderSystemPJ\Hello.WebApp\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "99c1551692d9ced10f5295e5b29b9deb1000a9c2"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"99c1551692d9ced10f5295e5b29b9deb1000a9c2", @"/Views/Home/Index.cshtml")]
...
<div class=""container-fluid p-0"" style=""height: 100vh; min-width: 1000px"">
    <div class=""float-left"" style=""width: 380px;height: 100vh;border-right: 2px solid #28a745"">
        ...
        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "99c1551692d9ced10f5295e5b29b9deb1000a9c25987", async() => {
            }
            );
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "99c1551692d9ced10f5295e5b29b9deb1000a9c27211", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_PartialTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.PartialTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_TagHelpers_PartialTagHelper);
...
#nullable disable
            WriteLiteral("                <div");
            BeginWriteAttribute("onclick", " onclick=\"", 2364, "\"", 2407, 5);
...
#nullable restore
#line 55 "C:\Users\KimAnh\source\repos\OrderSystemPJ\Hello.WebApp\Views\Home\Index.cshtml"
WriteAttributeValue(" ", 2394, item.price, 2395, 11, false);
...
#nullable disable
            ...
            BeginWriteAttribute("src", " src=\"", 2573, "\"", 2602, 1);
#nullable restore
#line 57 "C:\Users\KimAnh\source\repos\OrderSystemPJ\Hello.WebApp\Views\Home\Index.cshtml"
WriteAttributeValue("", 2579, "/image/"+item.image, 2579, 23, false);
        ...
        $(document).ready(function () {
            ...
            WriteLiteral(@"
                success: function (data) {
                    //console.log(data);
                    $.each(data, function (index, value) {
                        total += parseInt(value.price * value.quanlity * ((100 - value.discount) / 100));
                        discount += parseInt(value.price * value.quanlity * value.discount / 100);
                        var priceItem = parseInt(value.price * value.quanlity * ((100 - value.discount) / 100));
                        ...
                        var Data = `
      ");
            WriteLiteral(@"          <div onclick=""selectItem(` + value.iditem + `,` + value.discount + `,` + value.quanlity + `,` + value.idproduct + `,` + value.idorder + `,` + value.price + `)"" id=""idItemBox` + value.iditem + `"" class=""shadow-ok mb-2 item--box"" style=""width: 100%; border-radius: 10px"">
                ...
                <div class=""float-left p-1 pt-0"" style=""height: 50px;width: calc(100% - 170px);"">
                  ...
                  ");
            WriteLiteral(@" <div onclick=""deleteItem(` + value.iditem + `)"" class=""float-right p-1 bg-success text-center"" style=""width: 30px;height: 55px;border-top-right-radius: 10px;border-bottom-right-radius: 10px;"">
                ...
                <div class=""float-right p-1"" style=""width: 80px;height: 50px;"">
                    <p class=""font-weight-bold float-right cl"" style=""font-size: 90%"">` + priceItem + `đ</p>
                </div>
                <div style=""clear: both;""></div>
                ...
                <input style=""display:none"" id=""price`+ value.idproduct + `"" value=""` +");
