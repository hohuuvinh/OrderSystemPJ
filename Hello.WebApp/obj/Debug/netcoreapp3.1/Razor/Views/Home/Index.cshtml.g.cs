#pragma checksum "C:\Users\KimAnh\source\repos\OrderSystemPJ\Hello.WebApp\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6ccfb6d1cf0a1743cf7d7769373793112f29c4fa"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6ccfb6d1cf0a1743cf7d7769373793112f29c4fa", @"/Views/Home/Index.cshtml")]
...
<div class=""container-fluid p-0"" style=""height: 100vh; min-width: 1000px"">
    <div class=""float-left"" style=""width: 380px;height: 100vh;border-right: 2px solid #28a745"">
        ...
        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "6ccfb6d1cf0a1743cf7d7769373793112f29c4fa5978", async() => {
            }
            );
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "6ccfb6d1cf0a1743cf7d7769373793112f29c4fa7202", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_PartialTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.PartialTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_TagHelpers_PartialTagHelper);
    ...
    function addToCart(id,pricedf) {
        ...
        $(document).ready(function () {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (index, value) {
                        ...
                        console.log(id);
                     ");
            WriteLiteral(@"   if (value.idproduct == id) {
            ...
            WriteLiteral(@"{
                    ...
                    ");
            WriteLiteral(@"    var SetData = $(""#ListItem"");
                        SetData.html("""");
                        $.ajax({
                            method: ""post"",
        ...
        $(document).ready(function () {
            ...
            WriteLiteral(@"lue.quanlity;
                ...
                <div class=""float-left p-1 pt-0"" style=""height: 50px;width: calc(100% - 170px);"">
                    <p class=""font-weight-bold mb-0 cl ml-1"" style=""font-size: 90%"">` + value.name + ");
            WriteLiteral(@"`</p>
                ...
                <input");
            WriteLiteral(@" style=""display:none"" id=""discount`+ value.idproduct + `"" value=""` + value.discount + `""/>
