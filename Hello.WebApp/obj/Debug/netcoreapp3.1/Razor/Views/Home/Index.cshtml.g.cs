#pragma checksum "C:\Users\KimAnh\source\repos\OrderSystemPJ\Hello.WebApp\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "72c8add00217909348537a08148fe6f041abdcd3"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"72c8add00217909348537a08148fe6f041abdcd3", @"/Views/Home/Index.cshtml")]
...
<div class=""container-fluid p-0"" style=""height: 100vh; min-width: 1000px"">
    <div class=""float-left"" style=""width: 380px;height: 100vh;border-right: 2px solid #28a745"">
        ...
        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "72c8add00217909348537a08148fe6f041abdcd35987", async() => {
            }
            );
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "72c8add00217909348537a08148fe6f041abdcd37211", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_PartialTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.PartialTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_TagHelpers_PartialTagHelper);
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    //console.log(data);
                    $.each(data, function (index, value) {
                        total += parseInt(value.price * value.quanlity * ((100 - val");
            WriteLiteral(@"ue.discount) / 100));
                ...
                <div class");
            WriteLiteral(@"=""float-left"" style=""height: 55px;width: 60px;"">
 ...
 ");
            WriteLiteral(@"                   </div>
                ...
                <input style=""display:none"" id=""idorder`+ value.idproduct + `"" value=""` + value.idorder + `""/>
                    ...
                    $(""#total"").text(total);
                    $(""#");
            WriteLiteral(@"discount"").text(discount);
                    actionItemMax();
                }
    ...
    function selectItem(iditem, discount, quanlity, idproduct, idorder) {
